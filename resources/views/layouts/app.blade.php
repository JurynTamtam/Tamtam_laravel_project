    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    ...
                    <img alt="image" class="rounded-circle" src="img/id.png" style="width: 80px; height: 80px;" />
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="{{url('/book')}}">Manage Shop Item</a></li>
                        <li><a href="{{url('/customer')}}">Manage Customer</a></li>
                        <li><a href="{{url('/movies')}}">Manage Cart</a></li>
                    </ul>
                </li>
        </div>
    </nav>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">J&R APPAREL.</span>
                </li>
